...
export const docs = await create.docs(
  ...
  "content/docs",
  {
    ...
    "examples/meta.json": __fd_glob_1,
    "installation/meta.json": __fd_glob_2,
  },
  {
    "api-reference.mdx": __fd_glob_3,
    "best-practices.mdx": __fd_glob_4,
    "faq.mdx": __fd_glob_5,
    "index.mdx": __fd_glob_6,
    "migration-guid.mdx": __fd_glob_7,
    "quick-start.mdx": __fd_glob_8,
    "troubleshooting.mdx": __fd_glob_9,
    "examples/advanced.mdx": __fd_glob_10,
    "examples/environments.mdx": __fd_glob_11,
    "examples/index.mdx": __fd_glob_12,
    "examples/microservices.mdx": __fd_glob_13,
    "examples/nextjs.mdx": __fd_glob_14,
    "examples/nodejs.mdx": __fd_glob_15,
    "examples/saas.mdx": __fd_glob_16,
    "examples/serverless.mdx": __fd_glob_17,
    "examples/vite.mdx": __fd_glob_18,
    "installation/index.mdx": __fd_glob_19,
    "installation/nextjs.mdx": __fd_glob_20,
    "installation/nodejs.mdx": __fd_glob_21,
